...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/people/al-sadeq/61590873823181",
      icon: (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/alsadeq_sales_for_food",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@alsadeq.trading",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm text-stone-300 hover:text-amber-400 transition-colors block"
                  >
                    {t.footer.email}
                  </a>
                  <a
                    href="mailto:alsadeq_2000@yahoo.com"
                    className="text-sm text-stone-300 hover:text-amber-400 transition-colors block mt-0.5"
                  >
                    alsadeq_2000@yahoo.com
                  </a>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-300">
                    {workingHours
                      ? (isArabic ? workingHours.ar : workingHours.en)
                      : t.footer.hours}
                  </p>
                </div>
              </li>
